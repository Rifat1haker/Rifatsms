import os
print("\033[1;92m [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] RIFAT Haker (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] ROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92m   [[[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]][[🥭]]] UPDATE CHECKING MUEID MURSALIN RIFAT\033[1;30m")
os.system("git pull")
...
\033[1;94m[+]\033[1;32m               TOOL VERSION :  2.0                             \033[1;94m[+]
\033[1;94m[+]\033[1;32m               NETWORK      :   3G,4G,5G                           \033[1;94m[+]
\033[1;94m[+]\033[1;32m               TOOL STATUS  :  FREE                            \033[1;94m[+]
\033[1;94m[+]\033[1;32m               TOOL'S NAME  :  RANDOM SMS Bomber                 \033[1;94m[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m 💖RÌ£Ä†❤️ SMS WAS SENT🐼")
  else:
    pass
